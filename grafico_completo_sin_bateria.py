...
def analizar_estacion(estacion, sheet_name, recurso_solar_file, cargas_file):
    ...
    output_png = f"/home/nicole/UA/OFFGRID/OFFGRID/sistema_fotovoltaico_{estacion.lower()}.png"
    output_csv = f"/home/nicole/UA/OFFGRID/OFFGRID/datos_sistema_fotovoltaico_{estacion.lower()}.csv"
